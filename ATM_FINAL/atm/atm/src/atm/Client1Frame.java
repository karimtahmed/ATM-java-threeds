 ...
 * @author Familyytr
 */
public class Client1Frame extends javax.swing.JFrame  {
    int balance = 5000;
    
    
   static login l2=new login();
...
//    static server ser;
 ...
 static ServerGui server=new ServerGui();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setBackground(new java.awt.Color(85, 132, 172));
        buttonGroup2.add(jRadioButton1);
        jRadioButton1.setText("Client1");
        ...
        jRadioButton2.setBackground(new java.awt.Color(85, 132, 172));
        buttonGroup2.add(jRadioButton2);
        jRadioButton2.setText("Client3");
        ...
        jRadioButton3.setBackground(new java.awt.Color(85, 132, 172));
        buttonGroup2.add(jRadioButton3);
        jRadioButton3.setText("Client2");
...
//}
    ...
    private void WithdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WithdrawActionPerformed
        ...
        l2.operation2=Withdraw.getText();
        l2.money2=t1.getText();
...
//          if(ser.ClientBalance1 >= withdraw && withdraw<=7000)
//
//        {
//
//           ser.ClientBalance1 = ser.ClientBalance1 - withdraw;
//       labal.setText("Please collect your money");
//           System.out.println(ser.ClientBalance1);
//
//        }
//
//        else
...
//
//        server.jTextArea1.append("Bob withdrew "+mou+"\n");
    ...
    private void DepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DepositActionPerformed
       ...
       int deposit =Integer.parseInt(mou);
        // ser.ClientBalance1 = ser.ClientBalance1 + deposit;
     //   labal.setText("current blance= "+ser.ClientBalance1);
        ...
        server.setVisible(true);
        server.jTextArea1.append("Bob deposited "+mou+"\n");
   ...
   // labal.setText("Your Balance is "+Integer.toString(ser.ClientBalance1));
    String mou = t1.getText();
        server.jTextArea1.append("Bob Checked Balance "+mou+"\n");
...
//                ser.ClientBalance1-=money; 
//                 labal.setText("Transation Success");
//         server.jTextArea1.append("Bob Sent money to Zizo "+mou+"\n");
//
//            }
//            
//       
...
//    
    ...
    private void convertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertActionPerformed
        ...
        if (jRadioButton4.isSelected()) {
          ...
          server.jTextArea1.append("Bob Converted from EG->US "+mou+"\n");

             }
             else if (jRadioButton5.isSelected()) {
                 conv2=(float) (money*15.5);
          labal.setText(String.valueOf(conv2));
                    server.jTextArea1.append("Bob Converted from EG->EG "+mou+"\n");
    ...
    public static void main(String args[]) throws IOException {
       //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client1Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client1Frame().setVisible(true);
...
//
//            if("Withdraw Success".equals(fromServer)){
//                //nt2kd
//                 labal.setText(fromServer);
//               
//            }
//            
//            
...
//            
    ...
    public static javax.swing.JLabel labal;
